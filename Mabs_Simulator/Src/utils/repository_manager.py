...
class AbstractRepositoryManager(ABC):
    ...
    @staticmethod
    @abstractmethod
    def create_repository(directory_path):
        """
    ...
    @staticmethod
    @abstractmethod
    def create_repository_with_timestamp(relative_project_path):
        """
    ...
    @staticmethod
    @abstractmethod
    def delete_repository(directory_path):
        """
    ...
    @staticmethod
    @abstractmethod
    def get_repository_details(directory_path):
        """
    ...
    @staticmethod
    @abstractmethod
    def get_absolute_from_relative_path(cls, relative_project_path):
        """
    ...
    @staticmethod
    @abstractmethod
    def search_repositories(directory_path, keyword):
        """
    ...
    @staticmethod
    @abstractmethod
    def clone_repository(self, source_directory, target_directory):
        """
...
class RepositoryManager(AbstractRepositoryManager):
    ...
    @staticmethod
    def create_repository_with_timestamp(relative_project_path : str) -> bool:
        """
        Creates a new repository directory with the current time (up to nanosecond precision) as the repository name.
    ...
    def __init__(self, main_repository : str = "", role : str = None):
        '''
        Constructor
